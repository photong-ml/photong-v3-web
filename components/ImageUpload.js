...
export default function ImageUpload(
  ...
  const handleRemove = React.useCallback(() => {
    ...
    label = "Upload Image"
    description =
        "The image will be used to generate a soundtrack. Image can be up to 8MB."
    maxSizeInBytes = {8 * 1024 ** 2} maxFiles = {1} onChange =
        {handleChange} onRejected = {handleRejected} acceptedMimeTypes =
            {['image/png', 'image/jpeg', 'image/webp']} renderFile = {(file) => {
