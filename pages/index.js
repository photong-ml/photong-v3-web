...
export default function Home() {
  ...
  const generateAudio = async () => {
    ...
    const res = await fetch(
      `${config.API_URL}/infer?seed_img=${seedImg}&seed=${seed}&alpha=${alphas[nalphaIndex]}`,
      {
        method: "POST",
        body: formData,
      }
  ...
  const extendAudio = async () => {
    ...
    console.log(
      `Extending audio prompt ${prompt} seed ${nseed} alpha ${alphas[nalphaIndex]}`
    );
